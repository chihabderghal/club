...
export const MEMEBRS = [
    ...
    {
        image_path: "/images/djad_image.jpg",
    ...
    },
    {
        ...
        team: Team.DESIGN,
        position: Position.MEMBER,
        description: "ENGINEER and The one who asked ,i use arsh linux btw. #RTFM",
        system: faLinux,
    ...
    },
    {
        ...
        team: Team.FUN,
        position: Position.LEADER,
        description: "As a person who loves to explore and learn new things such as CS and other various fields in life(Professora fi l7ayat), I found myself here with you to express my thoughts and go through new experiences.",
        system: faWindows,
        github: "",
        linkedin: "",
