...
function Hero() {
    return (
        <section className="grid gap-8 md:grid-cols-2 bg-[#0d0d0d]  text-white py-52">
            {/* LEFT SIDE */}
            <div className="flex flex-col justify-center items-center text-center uppercase py-20">
                ...
                <Link href="#"
                      className="uppercase border-red-600 text-white text-center rounded-full p-3 bg-red-600 content-cente lg:flex">
                    event
                </Link>
            </div>             {/* RIGHT SIDE */}
